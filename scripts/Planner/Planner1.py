...
import scripts.sqp_solver.ProblemModelling1 as model
from scripts.Robot import Trajectory1 as Trajectory
from scripts.sqp_solver import SQPsolver1 as SQPsolver

...
class PlannerExample:
    def __init__(self):
        ...
        box_loc = [[0.364830659421, -0.264962595183, 0.9], [0.155743925678, -0.373197182129, 0.9]]
        ...
        print "nglsrngasl", box_loc[0]
        self.box_id = self.planner.add_constraint("box1", shape=self.planner.world.BOX, size=[0.05, 0.2, 0.20],
    ...
    def manual_control(self):
        ...
        self.planner.world.manual_control(self.robot_id, group)
